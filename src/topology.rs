...
impl DomainId {
    /// Constructs a domain identifier.
    ...
    /// Returns its system identifier.
    pub const fn system_id(self) -> i32 {
        self.system_id
    }
}

/// Query capability tied to a live runtime.
#[derive(Clone)]
pub struct Topology {
...
impl Topology {
    ...
    /// Returns visible system NUMA nodes.
    ...
    /// Returns visible domains at `level`.
    ...
    /// Returns CPUs contained by `domain`.
